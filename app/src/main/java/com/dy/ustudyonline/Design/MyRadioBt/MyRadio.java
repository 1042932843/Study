...
public class MyRadio extends android.support.v7.widget.AppCompatButton implements View.OnTouchListener{
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        if(0 == touch%2){
            this.setBackgroundResource(R.drawable.bg_round_corner_line_bg);
        }else {
            this.setBackgroundResource(R.drawable.btn_theme_solid_bg);
        }
        invalidate();
    }
