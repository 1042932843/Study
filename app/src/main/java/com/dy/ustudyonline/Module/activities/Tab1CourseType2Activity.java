...
public class Tab1CourseType2Activity extends BaseActivity {
    ...
    public void loadData() {
        ...
        RetrofitHelper.gethomePageTab1API()
                ...
                .subscribe(bean -> {
                    ...
                    switch (state){
                        case "0000":
                            JSONArray array=JSON.parseArray(apiMsg.getCourseList());
                            int size=array.size();
                            if(size>0){
    ...
    protected void initRecyclerView() {
        ...
        adapter.setOnItemClickListener(new CourseType2RecAdapter.OnItemClickListener() {
            ...
            public void onClick(String id) {
                Intent intent=new Intent(Tab1CourseType2Activity.this, IntroductionActivity.class);
    ...
    public void choseCourse(String courseTerrace_ids){
        pdialog = new ProgressDialog(Tab1CourseType2Activity.this, ProgressDialog.THEME_HOLO_LIGHT);
